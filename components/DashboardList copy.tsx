                    ...
                    <nav className="navbar navbar-expand-xl">
                        ...
                        <div className="collapse navbar-collapse" id="navbar-main-menu">
                            ...
                            <div className="header-customize justify-content-end align-items-center d-none d-xl-flex">
                                ...
                                <div className="header-customize-item">
                                    <a href="#add-categoria" className="btn btn-primary btn-icon-right" data-gtf-mfp="true"
                        ...
                        <ul className="list-group list-group-flush list-group-borderless">
                            ...
                            <li className="list-group-item p-0 mb-2 lh-15">
                                ...
                                <ul className="submenu collapse list-group list-group-flush list-group-borderless pt-2 mb-0 sidebar-menu"
                                    id="listing">
                                    <li className="list-group-item p-0 mb-2 lh-15"><a href="/dahsboardlist"
                                                                                  className="link-hover-dark-primary font-size-md">My
                                        Listing</a></li>
                                </ul>
                            </li>
                            <li className="list-group-item p-0 mb-2 lh-15">
                            ...
                            <div className="page-content">
                                <div className="tabs">
                                    <ul className="nav nav-pills tab-style-01 font-size-lg" role="tablist">
                                        ...
                                        <li className="nav-item">
                                            <a className="nav-link" id="active-tab" data-toggle="tab" href="#active"
                                               role="tab"
                                               aria-controls="active" aria-selected="false">Active Listings (12) </a>
                                        </li>
                                        <li className="nav-item">
                                            <a className="nav-link" id="pending-tab" data-toggle="tab" href="#pending"
                                               role="tab" aria-controls="pending" aria-selected="false"> Pending
                                                Listings
                                                (1) </a>
                                        </li>
                                        <li className="nav-item">
                                            <a className="nav-link" id="expires-tab" data-toggle="tab" href="#expires"
