        ...
        <div className="content-wrap">
            ...
            <section id="section-01" className="home-main-intro">
                <div className="home-main-intro-container">
                                   ...
                                   className="card border-0 link-hover-dark-white icon-box-style-01">
                                    <div className="card-body p-0">
                                        <svg className="icon icon-pharmaceutical">
                                            <use xlinkHref="#icon-pharmaceutical"/>
                                        </svg>
                                        <span className="card-text font-size-md font-weight-semibold mt-2 d-block">
											Medicals
										</span>
                    ...
                    <div className="home-main-how-it-work bg-white pt-11">
                        <div className="container">
                            <h2 className="mb-8">
                                <span>See</span>
                                <span className="font-weight-light">How It Works</span>
                            </h2>
                            <div className="row no-gutters pb-11">
                                <div className="col-lg-4 mb-4 mb-lg-0 px-0 px-lg-4">
                                    <div className="media icon-box-style-02" data-animate="fadeInDown">
                                        <div className="d-flex flex-column align-items-center mr-6">
                                            <svg className="icon icon-checkmark-circle">
                                                <use xlinkHref="#icon-checkmark-circle"/>
                                            </svg>
                                            <span className="number h1 font-weight-bold">1</span>
                                        </div>
                                        <div className="media-body lh-14">
                                            <h5 className="mb-3 lh-1">
                                                Choose What To Do
                                            </h5>
                                            <p className="font-size-md text-gray mb-0 text-muted">
                                ...
                                <div className="col-lg-4 mb-4 mb-lg-0 px-0 px-lg-4">
                                    <div className="media icon-box-style-02" data-animate="fadeInDown">
                                        <div className="d-flex flex-column align-items-center mr-6">
                                            ...
                                            <span className="number h1 font-weight-bold">2</span>
                                        </div>
                                        <div className="media-body lh-14">
                                            <h5 className="mb-3 lh-1">
                                                Find What You Want
                                ...
                                <div className="col-lg-4 mb-4 mb-lg-0 px-0 px-lg-4">
                                    <div className="media icon-box-style-02" data-animate="fadeInDown">
                                        <div className="d-flex flex-column align-items-center mr-6">
                                            ...
                                            <span className="number h1 font-weight-bold">3</span>
                                        </div>
                                        <div className="media-body lh-14">
                                            <h5 className="mb-3 lh-1">
            ...
            <section id="section-03" className="pb-8 our-directory">
                <div className="container">
                    <div className="mb-7">
                        <h2 className="mb-0">
                            <span className="font-weight-semibold">Our </span>
                            <span className="font-weight-light">Directory</span>
                        </h2>
                    </div>
                    <div className="d-flex align-items-center pb-8">
                        <ul className="nav nav-pills tab-style-01" role="tablist">
                            ...
                            <li className="nav-item">
                                <a className="nav-link" id="featured-tab" data-toggle="tab" href="#feature" role="tab"
                                   aria-controls="feature" aria-selected="false">featured</a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link" id="best-rate-tab" data-toggle="tab" href="#best-rate" role="tab"
                                   aria-controls="best-rate" aria-selected="false">best rate</a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link" id="most-view-tab" data-toggle="tab" href="#most-view" role="tab"
                                   aria-controls="most-view" aria-selected="false">most view </a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link" id="popular-tab" data-toggle="tab" href="#popular" role="tab"
                                   aria-controls="popular" aria-selected="false">popular</a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link" id="contact-tab" data-toggle="tab" href="#ad-directory" role="tab"
                                   aria-controls="ad-directory" aria-selected="false">ad directory</a>
                            </li>
                        </ul>
                        <div className="ml-auto d-flex slick-custom-nav pl-5">
                            <div className="arrow slick-prev disabled" id="previous"><i
                                    className="fas fa-chevron-left"></i></div>
                            <div className="arrow slick-next" id="next"><i
                ...
                <div className="container container-1720">
                    <div className="tab-content">
                       ...
                       <SliderMioDos/>
                        ...
                        <div className="tab-pane fade" id="best-rate" role="tabpanel" aria-labelledby="best-rate">
                            <div className="slick-slider arrow-top full-slide custom-nav"
                                 data-slick-options='{"slidesToShow": 5,"autoplay":false,"dots":false,"arrows":false,"responsive":[{"breakpoint": 2000,"settings": {"slidesToShow": 4}},{"breakpoint": 1500,"settings": {"slidesToShow": 3}},{"breakpoint": 1000,"settings": {"slidesToShow": 2}},{"breakpoint": 770,"settings": {"slidesToShow": 1}}]}'>
                                <div className="box" data-animate="fadeInUp">
                                    <div className="store card border-0 rounded-0">
                                        <div className="position-relative store-image">
                        ...
                        <div className="tab-pane fade" id="most-view" role="tabpanel" aria-labelledby="most-view">
                            <div className="slick-slider arrow-top full-slide custom-nav"
                                 data-slick-options='{"slidesToShow": 5,"autoplay":false,"dots":false,"arrows":false,"responsive":[{"breakpoint": 2000,"settings": {"slidesToShow": 4}},{"breakpoint": 1500,"settings": {"slidesToShow": 3}},{"breakpoint": 1000,"settings": {"slidesToShow": 2}},{"breakpoint": 770,"settings": {"slidesToShow": 1}}]}'>
                                <div className="box" data-animate="fadeInUp">
                                    <div className="store card border-0 rounded-0">
                                        ...
                                        <div className="card-body px-0 pb-0 pt-3">
                                            <a href="listing-details-full-image.html"
                                               className="card-title h5 text-dark d-inline-block mb-2"><span
                                                    className="letter-spacing-25">Karly Gomez Cake</span>
                                                <span className="check">
										<svg className="icon icon-check-circle"><use xlinkHref="#icon-check-circle"/></svg>
									</span>
                                            </a>
                                            <ul className="list-inline store-meta mb-4 font-size-sm d-flex align-items-center flex-wrap">
                                                <li className="list-inline-item"><span
                                        ...
                                        <div className="card-body px-0 pb-0 pt-3">
                                            <a href="listing-details-full-image.html"
                                               className="card-title h5 text-dark d-inline-block mb-2"><span
                                                    className="letter-spacing-25">Packing & Delivery Service</span>
                                                <span className="check">
										<svg className="icon icon-check-circle"><use xlinkHref="#icon-check-circle"></use></svg>
									</span>
                                            </a>
                                            <ul className="list-inline store-meta mb-4 font-size-sm d-flex align-items-center flex-wrap">
                                                <li className="list-inline-item"><span
                        ...
                        <div className="tab-pane fade" id="popular" role="tabpanel" aria-labelledby="popular">
                            <div className="slick-slider arrow-top full-slide custom-nav"
                                 data-slick-options='{"slidesToShow": 5,"autoplay":false,"dots":false,"arrows":false,"responsive":[{"breakpoint": 2000,"settings": {"slidesToShow": 4}},{"breakpoint": 1500,"settings": {"slidesToShow": 3}},{"breakpoint": 1000,"settings": {"slidesToShow": 2}},{"breakpoint": 770,"settings": {"slidesToShow": 1}}]}'>
                                <div className="box" data-animate="fadeInUp">
                                    <div className="store card border-0 rounded-0">
                        ...
                        <div className="tab-pane fade" id="ad-directory" role="tabpanel"
            ...
            {/*<!-- /#section-03 end -->*/}
            {/*<!-- #section 04 start -->*/}
            <section className="home-main-testimonial pt-12 pb-13" id="section-04">
                <div className="container">
                    <h2 className="mb-8">
            ...
            {/*<!-- /#section-04 end -->*/}
            {/*<!-- #section 05 start -->*/}
            <section id="section-05" className="pt-11 pb-11">
                <div className="container">
                    <div className="d-flex align-items-center mb-7 flex-wrap flex-sm-nowrap">
                        ...
                        <a href="blog-listing-grid.html"
                           className="link-hover-dark-primary ml-0 ml-sm-auto w-100 w-sm-auto">
                            <span className="font-size-md d-inline-block mr-1">All articles</span>
                            <i className="fal fa-chevron-right"></i>
                        </a>
                    </div>
                    <div className="row">
                        <div className="col-md-4 mb-4" data-animate="zoomIn">
                            <div className="card border-0">
                                <a href="blog-single-gallery.html" className="hover-scale">
                                    <img src="images/blog/main-blog-2.jpg" alt="product 1" className="card-img-top image"/>
                                </a>
                                <div className="card-body px-0">
                                    <div className="mb-2"><a href="#" className="link-hover-dark-primary">Tips</a>, <a
                                            href="#" className="link-hover-dark-primary">Travel</a></div>
                                    ...
                                    <ul className="list-inline">
                                        <li className="list-inline-item mr-0">
                                            <span className="text-gray">Aug 28th, 2017 by</span>
                                        </li>
                                        <li className="list-inline-item">
                                            <a href="#" className="link-hover-dark-primary">Admin</a>
                                        </li>
                        ...
                        <div className="col-md-4 mb-4" data-animate="zoomIn">
                            <div className="card border-0">
                                <a href="blog-single-gallery.html" className="hover-scale">
                                    <img src="images/blog/main-blog-3.jpg" alt="product 1" className="card-img-top image"/>
                                </a>
                                <div className="card-body px-0">
                                    <div className="mb-2"><a href="#" className="link-hover-dark-primary">Culture</a></div>
                                    <h5 className="card-title lh-13 letter-spacing-25"><a href="blog-single-gallery.html"
                                                                                      className="link-hover-dark-primary text-capitalize">Coffee
                                        On Street & Look Super Car</a>
                                    </h5>
                                    <ul className="list-inline">
                                        <li className="list-inline-item mr-0">
                                            <span className="text-gray">Aug 25th, 2017 by</span>
                                        </li>
                                        <li className="list-inline-item">
                                            <a href="#" className="link-hover-dark-primary">David</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div className="col-md-4 mb-4" data-animate="zoomIn">
                            <div className="card border-0">
                                <a href="blog-single-gallery.html" className="hover-scale">
                                    <img src="images/blog/main-blog-1.jpg" alt="product 1" className="card-img-top image"/>
                                </a>
                                <div className="card-body px-0">
                                    <div className="mb-2"><a href="#" className="link-hover-dark-primary">Location</a></div>
                                    <h5 className="card-title lh-13 letter-spacing-25"><a href="blog-single-gallery.html"
                                                                                      className="link-hover-dark-primary">MadCap
                                        Coffee At
                                    ...
                                    <ul className="list-inline">
                                        <li className="list-inline-item mr-0">
                                            <span className="text-gray">Aug 19th, 2017 by</span>
                                        </li>
                                        <li className="list-inline-item">
                                            <a href="#" className="link-hover-dark-primary">LoganCee</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
