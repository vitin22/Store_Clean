...
import { ADD_PRODUCTO, DEL_GRUPSERVICIO, ADD_GRUPSERVICIO, UPD_GRUPSERVICIO } from '@components/Apollo/jobs.mutations';
...
const GserviciosContent = () =>{
    ...
    const { loading: loader, data: datero , error: errore} = useQuery(PagGrupServ,
         ...
         const [deleteGrupoServicio, { error,data }] = useMutation(DEL_GRUPSERVICIO, {
          ...
          const [updateGrupoServicio, { error:erra,data:dato }] = useMutation(UPD_GRUPSERVICIO, {
              variables: {categoriaId, grupoId, nombre}
          });
...
const handleSubmit = async (event,updateGrupoServicio) => {
  
    event.preventDefault();
    await updateGrupoServicio().then(res => {
    console.log("sirvio")
                        ...
                        <div className="page-content-wrapper d-flex flex-column">
                            ...
                            <div className="page-content">
                                ...
                                Delete
                                                ...
                                                <div id="update-popupo" className="mfp-hide">
                                                    <p>Casa</p>
                                                    </div>



        <div id="update-popup" className="mfp-hide">
        ...
        <ul className="nav nav-pills tab-style-01 text-capitalize justify-content-center"
            ...
            <li className="nav-item">
                <a className="nav-link active" id="login-tab" data-toggle="tab"
                   href="#login"
                   role="tab"
                   aria-controls="login" aria-selected="true"><h3>Update Type de grupo de servicio</h3></a>
            </li>
    ...
    <div className="tab-content">
        <div className="tab-pane fade show active" id="login" role="tabpanel"
            ...
            <div className="form-login">
                <form onSubmit={event => handleSubmit(event,updateGrupoServicio)}>
                    ...
                    <button type="submit"
                            className="btn btn-primary btn-block font-weight-bold text-uppercase font-size-lg rounded-sm mb-8" onClick={()=>  updateGrupoServicio()}>
                        Update
                    </button>
                </form>
