...
import { ALL_TYPEPROD, PagTipoProduc} from '@components/Apollo/jobs.query';
...
const TipoProductoContent = () =>{
    const { loading: loader, data: datero , error: errore} = useQuery(PagTipoProduc,
         );
                            ...
                            <div className="page-content">
                                ...
                                <div className="tab-content">
                                    <div className="tab-pane fade show active" id="all" role="tabpanel"
                                        ...
                                        {datero.allTipoProducto.edges.map(prestador => {
                                return (
...
export default withApollo(TipoProductoContent);