...
const InstertarCategoria = (props) => {
    ...
    {/*<!-- #header start -->*/}
        <header id="header" className="main-header header-sticky header-sticky-smart header-style-01 text-uppercase">
                ...
                <div className="container container-1720">
                    <nav className="navbar navbar-expand-xl">
                        ...
                        <div className="collapse navbar-collapse" id="navbar-main-menu">
                            <a className="navbar-brand d-none d-lg-block mr-auto" href="index.html">
                                <img src="images/logo.png" alt="TheDir"/>
                            </a>
    ...
    {/*<!-- .header-customize-cart start -->*/}
                                    <div className="header-customize-cart">
                                        <a className="mini-cart-icon d-flex align-items-end link" href="#"
                                           title="Shopping Cart">
                                            <svg className="icon icon-bag-1">
                                                <use xlinkHref="#icon-bag-1"></use>
                                            </svg>
                                            <span>(2)</span> </a>

                                        <div className="shopping-cart-popup animated fadeIn">
                                            <ul className="list-group list-group-flush">
                                                <li className="list-group-item bg-transparent px-0 pb-4 d-flex align-items-start">
                                                    <a href="shop-single-product.html"
                                                       className="media align-items-start text-dark text-decoration-none">
                                                        <div className="image mr-3">
                                                            <img src="images/shop/cart-1.jpg"
                                                                 title="Product 01"/>
                                                        </div>
                                                        <div className="media-body lh-14">
                                                            <span className="d-block font-size-md text-capitalize font-weight-normal">Black Printed T-shirt</span>
                                                            <span className="font-weight-normal">$39.00</span>
                                                        </div>

                                                    </a>
                                                    <a href="#" className="close ml-auto link-hover-darker-light-dark"><i
                                                            className="fal fa-times"></i></a>
                                                </li>
                                                <li className="list-group-item bg-transparent px-0 pt-3 pb-4 d-flex align-items-start">
                                                    <a href="shop-single-product.html"
                                                       className="media align-items-start text-dark text-decoration-none">
                                                        <div className="image mr-3">
                                                        ...
                                                        <div className="media-body lh-14">
                                                            <span className="d-block font-size-md text-capitalize font-weight-normal">White Retro Sneaker</span>
                                                            <span className="font-weight-normal">$29.00</span>
                                                        </div>
                                                    </a>
                                                    <a href="#" className="close ml-auto link-hover-darker-light-dark"><i
                                                            className="fal fa-times"></i></a>
                                                </li>
                                                <li className="list-group-item bg-transparent px-0 d-flex align-items-center py-5">
                                                    <span className="text-uppercase font-size-md text-dark">Sub total</span>
                                                    <span className="ml-auto text-primary h5 mb-0">$55.00</span>
                                                </li>
                                            </ul>
                                            <div className="mt-6 row mx-n2">
                                                <div className="col-6 px-2">
                                                    <a href="shop-shopping-cart.html"
                                                       className="btn btn-primary btn-icon-right btn-block font-size-base py-2">View
                                                        cart <i className="fal fa-chevron-right"></i></a>
                                                </div>
                                                <div className="col-6 px-2">
                                                    <a href="shop-checkout.html"
                                                       className="btn btn-gray btn-icon-right btn-block text-white font-size-base py-2">Checkout
