...
import { REGISTRAR_MUTATION } from './Apollo/jobs.mutations';
import { useMutation, useQuery } from '@apollo/react-hooks';
import Estilo from './ScriptLogin'
...
import { All_BARRIOS, All_CATEGORIAS, All_Categories } from './Apollo/jobs.query';
...
const Registrar = () => {
  ...
  const [nombreCompannia, setnombreCompannia] = useState('');
  ...
  const [newUser, { error,data: datol }] = useMutation(REGISTRAR_MUTATION, {
    variables: { aPagar , barrio, card, categoriaEmpresa, country, email, fullname, name, nombreCompannia, nombreEmpresa, password, phone, premium, sell, tarjeta, username} 
   
  });

  const { loading: carga, data: datos } = useQuery(All_BARRIOS);
  const { loading: cargar, data: dato } = useQuery(All_CATEGORIAS);


  /*{dato.allCategorias.edges.map(cat => (
    
    <option value={cat.node.id}>{cat.node.id}</option>
 
))}

{datos.allBarrios.edges.map(cat => (
    
  <option value={cat.node.id}>{cat.node.id}</option>

))}*/

/* {datos.allBarrios.edges.map(prod => (
          
            <option key={prod.node.id} value={prod.node.id}>{prod.node.id}</option>
          
        ))}*/


/*const [registery, { error, data }] = useMutation(REGISTRAR_MUTATION, {
...
const displayBarrios = () => {

  if(carga){
    return( <option disabled>Loading barrios</option>);
  }
  else
  {
    
    return datos.allBarrios.edges.map(cat => {
    
      return ( <option key={cat.node.id} value={cat.node.id}>{cat.node.id}</option>);
...
const displayCategoria = () => {
  ...
  else
  {
    ...
    return dato.allCategorias.edges.map(cat => {
...
/*               { error ? 
    console.log(error.message) : 
    datol && datol.newUser ? console.log("salvado") : console.log("nada")
    ...
    <div className="limiter">
      <div className="container-login100">
        <div className="wrap-login100">
          ...
          <form className="login100-form validate-form" onSubmit={event => handleSubmit(event,newUser)}>
        ...
        <div className="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
            <label>
          <input name="shell" type="checkbox" checked={sell} onChange={e => setsell(e.target.checked)}  /> shell
        </label>
        </div>
        ...
        <div className="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
        <label>
          <input name="premium" type="checkbox" checked={premium} onChange={e => setpremium(e.target.checked)}  /> premium
        </label>
        </div>
       ...
       className="input-select">
         <option>Barrio</option>
            ...
            <div className="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
              <input className="input100" type="text" name="tarjeta" value={tarjeta} onChange={e => settarjeta(e.target.value)} placeholder="tarjeta"/>
            ...
            <div className="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
              <input className="input100" type="text" name="phone" value={phone} onChange={e => setphone(e.target.value)} placeholder="phone"/>
              <span className="focus-input100"></span>
              <span className="symbol-input100">
            ...
            <div className="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
              <input className="input100" type="text" name="nombreEmpresa" value={nombreEmpresa} onChange={e => setnombreEmpresa(e.target.value)} placeholder="nombreEmpresa"/>
              <span className="focus-input100"></span>
              <span className="symbol-input100">
            ...
            <div className="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
              <input className="input100" type="text" name="nombreCompannia" value={nombreCompannia} onChange={e => setnombreCompannia(e.target.value)} placeholder="nombreCompannia"/>
              <span className="focus-input100"></span>
              <span className="symbol-input100">
            ...
            <div className="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
              <input className="input100" type="text" name="fullname" value={fullname} onChange={e => setfullname(e.target.value)} placeholder="fullname"/>
              <span className="focus-input100"></span>
              <span className="symbol-input100">
            ...
            <div className="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
              <input className="input100" type="text" name="name" value={name} onChange={e => setname(e.target.value)} placeholder="name"/>
              <span className="focus-input100"></span>
              <span className="symbol-input100">
                <i className="fa fa-address-card" aria-hidden="true"></i>
              </span>
            ...
            <div className="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
              <input className="input100" type="text" name="country" value={country} onChange={e => setcountry(e.target.value)} placeholder="country"/>
              <span className="focus-input100"></span>
              <span className="symbol-input100">
            ...
            <div className="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
              <input className="input100" type="text" name="card" value={card} onChange={e => setcard(e.target.value)} placeholder="card"/>
              <span className="focus-input100"></span>
              <span className="symbol-input100">
                <i className="fa fa-credit-card-alt" aria-hidden="true"></i>
              </span>
            ...
            <div className="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
              <input className="input100" type="text" name="aPagar" value={aPagar} onChange={e => setaPagar(parseInt(e.target.value))} placeholder="a pagar"/>
              <span className="focus-input100"></span>
              <span className="symbol-input100">
            ...
            <div className="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
              <input className="input100" type="text" name="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="Email"/>
              <span className="focus-input100"></span>
              <span className="symbol-input100">
            ...
            <div className="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
              <input className="input100" type="text" name="username" value={username} onChange={e => setUsername(e.target.value)} placeholder="User" required/>
              <span className="focus-input100"></span>
              <span className="symbol-input100">
            ...
            <div className="container-login100-form-btn">
              <button className="login100-form-btn" onClick={()=> newUser()}>
                Login
              </button>
            </div>
